"""
Assembles a DailyReport from normalized, deduplicated, enriched, and
prioritized collections. Phase 4 will replace the placeholder summaries.
"""
...
from pipeline.prioritizer import get_featured_vulnerabilities
...
def build_report(
    ...
    # Assumes assign_priority_tiers() has already been called on vulnerabilities
    featured = get_featured_vulnerabilities(vulnerabilities)
    ...
    return DailyReport(
        ...
        featured_vulnerabilities=featured,
...
def _placeholder_executive(
    ...
    return (
        ...
        f"and {len(events)} threat events."
    )
